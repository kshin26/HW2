...
/*******
 * <p> Title: PasswordRecognizerTestbed. </p>
 * 
 ...
 * 
 * @version 1.00  2024-09-13 The mainline of a console terminal implementation of a Password
 *                  Recognizer testbed
 * 
 */

public class PasswordRecognizerTestbed {
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to the Password Recognizer Testbed\n");
        System.out.println("Please enter a Password or an empty line to stop.");
		...
		while (keyboard.hasNextLine()) {
			...
			// Input has been provided, let's see if it is a valid password or not
 			String errMessage = PasswordRecognizer.checkForValidPassword(inputLine);
			...
			if (errMessage != "") {
				...
				if (PasswordRecognizer.passwordRecognizerIndexOfError <= -1) return;	// Should never happen
				...
				System.out.println(inputLine.substring(0,PasswordRecognizer.passwordRecognizerIndexOfError) + "\u21EB");
			}
			else {
	        ...
	        System.out.println("\nPlease enter a Password or an empty line to stop.");
